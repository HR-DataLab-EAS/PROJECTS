...
Het **HR DataLab EAS** is een cross-functioneel Agile team. Bestaande uit  5-tal docent datawetenschappers + Tech support.  Hieronder staan actuele DS use cases beschreven in de vorm een informatiewaardeketen en bijbeborende DS-workflow.
